...
import com.allexis.randomcontactsapp.core.network.service.common.model.GsonObject
...
@Parcelize data class UserResult(val results: List<User>,
                                 val info: UserResultInfo) : Parcelable, GsonObject()